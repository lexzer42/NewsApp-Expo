...
const NewsList = () => {
    const { articles, savedArticles, loading, error, currentPage, hasMorePages, currentCategory } = useAppSelector((state) => state.news);
    ...
    const isArticleSaved = useCallback((url: string) => {
                ...
                <Card.Content>
                    ...
                    <View style={styles.sourceContainer}>
                        ...
                        <Caption style={styles.date}>
                            {format(new Date(item.publishedAt), "dd MMM")}
                        </Caption>
                    </View>
