      ...
      <Card style={styles.card}>
        ...
        <Card.Content style={styles.content}>
          ...
          <View style={styles.infoContainer}>
            <Paragraph style={styles.infoLabel}>Autor:</Paragraph>
            <Paragraph style={styles.infoValue}>{article.author || 'Desconocido'}</Paragraph>

            <Paragraph style={styles.infoLabel}>Fuente:</Paragraph>
            <Paragraph style={styles.infoValue}>{article.source.name}</Paragraph>
          </View>
        </Card.Content>
